...
class Meas(QObject):
    ...
    def __init__(self, mutex, NDpts):
        ...
        sg1_name = 'USB0::0x0957::0x2C07::MY57801011::0::INSTR'
    ...
    def prepForMeas(self):
        if self.co == 0:
            self.logMessage.emit("V1= {0:8.3f}  V2={1:8.3f} dV2={2:8.3f}  f={3:5.1f} kHz".format(
                self.V1c, self.V2c, self.dV2, self.fsig/1000))
        if self.co % 2 == 0:
